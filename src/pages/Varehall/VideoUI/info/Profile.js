...
const Register = ({setLoginUser, loginUser, info, onHandleQuery}) => {
  ...
  useEffect(() => {
    ...
    myNameRef.current.value = storeUser && storeUser.name ? storeUser.name : "";
    myEmailRef.current.value =
      storeUser && storeUser.email ? storeUser.email : "";
    myPhoneRef.current.value =
      storeUser && storeUser.phone ? storeUser.phone : "";
  }, []);
  ...
  const updateRegister = async () => {
    ...
    if (myNameRef.current.value) {
      queryObject["fullName"] = myNameRef.current.value;
    }
    if (myPhoneRef.current.value) {
      queryObject["phone"] = myPhoneRef.current.value;
    }
  ...
  const handleLogin = queryObject => {
    console.log("queryObject", queryObject);

    if (queryObject.email && queryObject.password) {
      const formData = {
        request: "login",
        query: {
          email: queryObject.email.toLowerCase(),
            ...
            >
              ...
              >
                ...
                >
                  ...
                  >
                    Please create your varehall user profile.
                  </div>
                </div>
