...
const surveyList = [
      {
        ...
        "status": "COMPLETED",
        "category": "H.R. 7994 - To authorize the President to award the Purple Heart to Anselm \"Jerry\" Cramer for injuries incurred during the Korean War while a member of the Marine Corps.",
        "labelColor": "red",
        "label": 'Yes'
      },
      {
                 ...
                 <Col lg={12} sm={12}>
                  ...
                  <Row style={{
                    paddingBottom:50
                      ...
                      ? <Fragment>
                        <TableRecord
                          title={'Your Constituency Demography Response Breakdown'}
                          data={bills}
                        />
